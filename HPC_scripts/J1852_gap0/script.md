...
OMP_NUM_THREADS=8 OMP_DYNAMIC=FALSE MKL_NUM_THREADS=8 OPENBLAS_NUM_THREADS=8 NUMEXPR_NUM_THREADS=8 \
...
CASA_NUM_THREADS=8 OMP_NUM_THREADS=8 OMP_DYNAMIC=FALSE MKL_NUM_THREADS=8 OPENBLAS_NUM_THREADS=8 NUMEXPR_NUM_THREADS=8 \
...
nohup casa --pipeline --configfile "$CASA_CONFIG" --nogui --nologger --nologfile \
  -c AA_Tau_robust2_0_gap2_imageloop.py > imageloop.log 2>&1 &
