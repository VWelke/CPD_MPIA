...
os.system('/usr/local/bin/CASA/casa-6.6.1-17-pipeline-2024.1.0.8/bin/casa --nogui --nologger --nologfile -c ../Source_codes/prepimaging_casa.py')
...
os.system('/usr/local/bin/CASA/casa-6.6.1-17-pipeline-2024.1.0.8/bin/casa --nogui --nologger --nologfile -c ../Source_codes/mask_to_casa.py')