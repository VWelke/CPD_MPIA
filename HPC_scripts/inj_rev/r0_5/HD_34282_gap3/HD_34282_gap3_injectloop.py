...
target = 'HD_34282'	# CSD name
gap_ix = 3		# which gap CPD is in (based on dict list)
...
# frank setup
Rmax, Ncoll = 2 * disk.disk[target].get('R90', disk.disk[target]['rout']), disk.disk[target]['hyp-Ncoll']
