...
WORKDIR="/nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/r0_5_rout/J1615_gap0"
...
if [ -f "injections/J1615_gap0_mpars.0.txt" ]; then
    echo "=== [J1615 gap0] Inject already done, skipping ==="
else
    echo "=== [J1615 gap0] Inject start: $(date) ==="
...
echo "=== [J1615 gap0] Recovery start: $(date) ==="
...
echo "=== [J1615 gap0] Pipeline complete: $(date) ==="
