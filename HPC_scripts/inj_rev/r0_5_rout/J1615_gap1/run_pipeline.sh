...
WORKDIR="/nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/r0_5_rout/J1615_gap1"
...
if [ -f "injections/J1615_gap1_mpars.0.txt" ]; then
    echo "=== [J1615 gap1] Inject already done, skipping ==="
else
    echo "=== [J1615 gap1] Inject start: $(date) ==="
...
echo "=== [J1615 gap1] Prepimaging start: $(date) ==="
...
echo "=== [J1615 gap1] Imageloop start: $(date) ==="
CASA_NUM_THREADS=2 OMP_NUM_THREADS=2 OMP_DYNAMIC=FALSE MKL_NUM_THREADS=2 OPENBLAS_NUM_THREADS=2 NUMEXPR_NUM_THREADS=2 \
...
echo "=== [J1615 gap1] Recovery start: $(date) ==="
...
echo "=== [J1615 gap1] Pipeline complete: $(date) ==="
