...
WORKDIR="/nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/r0_5_rout/LkCa_15_gap0"
...
echo "=== [LkCa_15 gap0] Imageloop start: $(date) ==="
CASA_NUM_THREADS=2 OMP_NUM_THREADS=2 OMP_DYNAMIC=FALSE MKL_NUM_THREADS=2 OPENBLAS_NUM_THREADS=2 NUMEXPR_NUM_THREADS=2 \
...
echo "=== [LkCa_15 gap0] Recovery start: $(date) ==="
...
echo "=== [LkCa_15 gap0] Pipeline complete: $(date) ==="
