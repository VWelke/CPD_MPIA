...
def inject_CPD(data, CPD_pars, incl=0, PA=0, offRA=0, offDEC=0):
    ...
    # real part : Flux (mJy) to Jy times an array of ones with the shape of u 
    # imag part : zeros, 1.0j is imaginary unit in python
    # visibility = flux*exp(2pii*baseline*position)
