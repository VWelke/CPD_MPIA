...
disk = {'AA_Tau': {'PA': 93.77079777,
            ...
            'RMS': np.float64(33.141724998131394),
            'ccycleniter': 300,
            'cgain': 0.3,
 ...
 'CQ_Tau': {'PA': 53.87180444,
            ...
            'name': 'CQ_Tau',
            'rgap': [],
            'rout': np.float64(0.6699791550636854),
            'wgap': []},
 'DM_Tau': {'PA': 155.59975598,
            'R90': np.float64(1.402),
            'RMS': np.float64(27.46016798482742),
            'ccycleniter': 300,
            'cgain': 0.3,
 ...
 'HD_135344B': {'PA': 28.92070668,
                ...
                'name': 'HD_135344B',
                'rgap': [0.098, 0.493],
                'rout': np.float64(0.041268339380619),
                'wgap': [0.302, 0.084]},
 'HD_143006': {'PA': 7.53236754,
               'R90': np.float64(0.4778),
               'RMS': np.float64(34.64745168457739),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'HD_143006',
               'rgap': [0.132, 0.316],
               'rout': np.float64(0.5812761234119175),
               'wgap': [0.111, 0.084]},
 'HD_34282': {'PA': 117.79519232,
              'R90': np.float64(0.7759),
              'RMS': np.float64(30.82231523876544),
              'ccycleniter': 300,
              'cgain': 0.3,
 ...
 'J1604': {'PA': 123.24221853,
           ...
           'name': 'J1604',
           'rgap': [],
           'rout': np.float64(0.0134539175778615),
           'wgap': []},
 'J1615': {'PA': 146.14327945,
           'R90': np.float64(1.09),
           'RMS': np.float64(26.927682483801618),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'rout': np.float64(1.5203654794022308),
           'wgap': [0.09, 0.09, 0.04]},
 'J1842': {'PA': 26.35016474,
           'R90': np.float64(0.5645),
           'RMS': np.float64(31.450428650714457),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1842',
           'rgap': [0.419],
           'rout': np.float64(0.0135741233825685),
           'wgap': [0.039]},
 'J1852': {'PA': 117.61494041,
           'R90': np.float64(0.475),
           'RMS': np.float64(26.345420337747782),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1852',
           'rgap': [0.21],
           'rout': np.float64(0.014018568210306),
           'wgap': [0.152]},
 'LkCa_15': {'PA': 61.57232522,
             'R90': np.float64(0.9943),
             'RMS': np.float64(27.92454142763745),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'LkCa_15',
             'rgap': [0.093, 0.549],
             'rout': np.float64(0.010301394388081501),
             'wgap': [0.327, 0.077]},
 'MWC_758': {'PA': 76.17365568,
             'R90': np.float64(0.5862),
             'RMS': np.float64(42.25328302709386),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'MWC_758',
             'rgap': [0.193, 0.384],
             'rout': np.float64(0.07344938814639751),
             'wgap': [0.265, 0.059]},
 'PDS_66': {'PA': 8.91316735,
            'R90': np.float64(0.4788),
            'RMS': np.float64(33.9901125698816),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'PDS_66',
            'rgap': [],
            'rout': np.float64(0.646051448769867),
            'wgap': []},
 'SY_Cha': {'PA': 165.76511321,
            'R90': np.float64(1.094),
            'RMS': np.float64(39.510585338575765),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'SY_Cha',
            'rgap': [0.184],
            'rout': np.float64(0.11633038055151299),
            'wgap': [0.409]},
 'V4046_Sgr': {'PA': 76.02083693,
               'R90': np.float64(0.852),
               'RMS': np.float64(28.42581397999311),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'V4046_Sgr',
               'rgap': [0.105, 0.285],
               'rout': np.float64(1.1404567146671907),
               'wgap': [0.101, 0.141]}}
