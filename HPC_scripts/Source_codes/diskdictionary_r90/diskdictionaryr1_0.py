...
disk = {'AA_Tau': {'PA': 93.77079777,
            ...
            'RMS': np.float64(23.882555979071185),
            'ccycleniter': 300,
            'cgain': 0.3,
 ...
 'CQ_Tau': {'PA': 53.87180444,
            ...
            'name': 'CQ_Tau',
            'rgap': [],
            'rout': np.float64(0.7749377936124751),
            'wgap': []},
 'DM_Tau': {'PA': 155.59975598,
            'R90': np.float64(1.402),
            'RMS': np.float64(20.931666767864954),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'rout': np.float64(1.4597551086919378),
            'wgap': [0.088, 0.13, 0.046]},
 'HD_135344B': {'PA': 28.92070668,
                'R90': np.float64(0.6681),
                'RMS': np.float64(20.359314476081636),
                'ccycleniter': 300,
                'cgain': 0.3,
                ...
                'name': 'HD_135344B',
                'rgap': [0.098, 0.493],
                'rout': np.float64(1.0576910711825325),
                'wgap': [0.302, 0.084]},
 'HD_143006': {'PA': 7.53236754,
               'R90': np.float64(0.4778),
               'RMS': np.float64(21.836478481418453),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'HD_143006',
               'rgap': [0.132, 0.316],
               'rout': np.float64(0.7084949351846805),
               'wgap': [0.111, 0.084]},
 'HD_34282': {'PA': 117.79519232,
              'R90': np.float64(0.7759),
              'RMS': np.float64(21.45564758393448),
              'ccycleniter': 300,
              'cgain': 0.3,
 ...
 'J1604': {'PA': 123.24221853,
           ...
           'name': 'J1604',
           'rgap': [],
           'rout': np.float64(0.027372794225814),
           'wgap': []},
 'J1615': {'PA': 146.14327945,
           'R90': np.float64(1.09),
           'RMS': np.float64(17.987786122830585),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'rout': np.float64(1.8945413269103475),
           'wgap': [0.09, 0.09, 0.04]},
 'J1842': {'PA': 26.35016474,
           'R90': np.float64(0.5645),
           'RMS': np.float64(20.19111161644105),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1842',
           'rgap': [0.419],
           'rout': np.float64(0.9634100794792335),
           'wgap': [0.039]},
 'J1852': {'PA': 117.61494041,
           'R90': np.float64(0.475),
           'RMS': np.float64(17.455011402489617),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1852',
           'rgap': [0.21],
           'rout': np.float64(0.8377992864697634),
           'wgap': [0.152]},
 'LkCa_15': {'PA': 61.57232522,
             'R90': np.float64(0.9943),
             'RMS': np.float64(19.676190277095884),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'LkCa_15',
             'rgap': [0.093, 0.549],
             'rout': np.float64(1.446745615452639),
             'wgap': [0.327, 0.077]},
 'MWC_758': {'PA': 76.17365568,
             'R90': np.float64(0.5862),
             'RMS': np.float64(26.858600904233754),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'MWC_758',
             'rgap': [0.193, 0.384],
             'rout': np.float64(0.8008975926786555),
             'wgap': [0.265, 0.059]},
 'PDS_66': {'PA': 8.91316735,
            'R90': np.float64(0.4788),
            'RMS': np.float64(23.901582608232275),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'PDS_66',
            'rgap': [],
            'rout': np.float64(0.864557225257176),
            'wgap': []},
 'SY_Cha': {'PA': 165.76511321,
            'R90': np.float64(1.094),
            'RMS': np.float64(26.754335522127803),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'SY_Cha',
            'rgap': [0.184],
            'rout': np.float64(1.417713573202416),
            'wgap': [0.409]},
 'V4046_Sgr': {'PA': 76.02083693,
               'R90': np.float64(0.852),
               'RMS': np.float64(19.805009287665598),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'V4046_Sgr',
               'rgap': [0.105, 0.285],
               'rout': np.float64(1.7028004601599156),
               'wgap': [0.101, 0.141]}}