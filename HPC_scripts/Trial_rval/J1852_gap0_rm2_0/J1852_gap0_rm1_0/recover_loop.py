...
import diskdictionaryrm1_0 as disk
...
for i in range(len(Fstr)):
    ...
    # /nexus/posix0/MIA-astro-env/myben/vawelke/J1852_gap0/resid_images/
    hdu = fits.open(f'/nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/{target}_gap{gap}/resid_images/' + im_file + '.resid.fits')
