...
nohup python -u AA_Tau_gap3_injectloop.py > inject.log 2>&1 & disown


deactivate

pgrep -af AA_Tau_gap3_injectloop.py
tail -f inject.log


# Prepimaging
# RMB change cmask to [512pix,512pix]
cd /nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/AA_Tau_gap3/
...
nohup casa --pipeline --configfile $CASA_CONFIG --nogui --nologger --nologfile -c "execfile('AA_Tau_robust2_0_gap3_imageloop.py')" > imageloop.log 2>&1 & disown
...
rsync -av --progress \
astronode1:/nexus/posix0/MIA-astro-env/myben/vawelke/inj_rev/AA_Tau_gap0/recoveries/ \
/mnt/d/CPD_MPIA/HPC_scripts/AA_Tau_gap0/recoveries/
