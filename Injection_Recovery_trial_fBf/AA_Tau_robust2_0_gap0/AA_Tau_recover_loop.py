...
target = 'AA_Tau'  # Changed to match your setup
gap = 0
ix = '0'           # Changed to match your subsuf
...
for i in range(len(Fstr)):
    ...
    hdu = fits.open('resid_images/' + im_file + '.JvMcorr.fits')  # Updated path
