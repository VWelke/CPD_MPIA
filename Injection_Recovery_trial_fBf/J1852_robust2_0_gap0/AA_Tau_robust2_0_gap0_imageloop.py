...
for i in range(len(Fstr)):
    ...
    ImportMS('/mnt/d/exoALMA_disk_data/measurement_set_spavg/' +target+'_time_ave_continuum_spavg.ms', rfile, suffix=resid_suffix, 
             make_resid=False)
    ...
    # clean
    tclean(vis='/mnt/d/exoALMA_disk_data/measurement_set_spavg/'+target+'_time_ave_continuum_spavg.'+resid_suffix+'.ms',
