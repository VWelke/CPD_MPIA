...
disk = {'AA_Tau': {'PA': 93.77079777,
            ...
            'RMS': np.float64(49.06031063001137),
            'ccycleniter': 300,
            'cgain': 0.3,
 ...
 'CQ_Tau': {'PA': 53.87180444,
            ...
            'name': 'CQ_Tau',
            'rgap': [],
            'rout': np.float64(0.629281941801345),
            'wgap': []},
 'DM_Tau': {'PA': 155.59975598,
            'R90': np.float64(1.402),
            'RMS': np.float64(44.60928903426975),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'rout': np.float64(0.6722571412102993),
            'wgap': [0.088, 0.13, 0.046]},
 'HD_135344B': {'PA': 28.92070668,
                'R90': np.float64(0.6681),
                'RMS': np.float64(56.645487347850576),
                'ccycleniter': 300,
                'cgain': 0.3,
                ...
                'name': 'HD_135344B',
                'rgap': [0.098, 0.493],
                'rout': np.float64(0.010509477928281),
                'wgap': [0.302, 0.084]},
 'HD_143006': {'PA': 7.53236754,
               'R90': np.float64(0.4778),
               'RMS': np.float64(55.438806157326326),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'HD_143006',
               'rgap': [0.132, 0.316],
               'rout': np.float64(0.5461975643411385),
               'wgap': [0.111, 0.084]},
 'HD_34282': {'PA': 117.79519232,
              'R90': np.float64(0.7759),
              'RMS': np.float64(44.48283289093524),
              'ccycleniter': 300,
              'cgain': 0.3,
 ...
 'J1604': {'PA': 123.24221853,
           ...
           'name': 'J1604',
           'rgap': [],
           'rout': np.float64(0.01147206313908),
           'wgap': []},
 'J1615': {'PA': 146.14327945,
           'R90': np.float64(1.09),
           'RMS': np.float64(43.841417209478095),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'rout': np.float64(1.1505246600135872),
           'wgap': [0.09, 0.09, 0.04]},
 'J1842': {'PA': 26.35016474,
           'R90': np.float64(0.5645),
           'RMS': np.float64(51.39883069205098),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1842',
           'rgap': [0.419],
           'rout': np.float64(0.0117134731262925),
           'wgap': [0.039]},
 'J1852': {'PA': 117.61494041,
           'R90': np.float64(0.475),
           'RMS': np.float64(38.732876419089735),
           'ccycleniter': 300,
           'cgain': 0.3,
           ...
           'name': 'J1852',
           'rgap': [0.21],
           'rout': np.float64(0.011941256932915499),
           'wgap': [0.152]},
 'LkCa_15': {'PA': 61.57232522,
             'R90': np.float64(0.9943),
             'RMS': np.float64(38.14113006228581),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'LkCa_15',
             'rgap': [0.093, 0.549],
             'rout': np.float64(0.009154476225378001),
             'wgap': [0.327, 0.077]},
 'MWC_758': {'PA': 76.17365568,
             'R90': np.float64(0.5862),
             'RMS': np.float64(71.25925912987441),
             'ccycleniter': 300,
             'cgain': 0.3,
             ...
             'name': 'MWC_758',
             'rgap': [0.193, 0.384],
             'rout': np.float64(0.0120037281885765),
             'wgap': [0.265, 0.059]},
 'PDS_66': {'PA': 8.91316735,
            'R90': np.float64(0.4788),
            'RMS': np.float64(52.72660382615868),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'PDS_66',
            'rgap': [],
            'rout': np.float64(0.5992992436513724),
            'wgap': []},
 'SY_Cha': {'PA': 165.76511321,
            'R90': np.float64(1.094),
            'RMS': np.float64(66.33693556068465),
            'ccycleniter': 300,
            'cgain': 0.3,
            ...
            'name': 'SY_Cha',
            'rgap': [0.184],
            'rout': np.float64(0.075726117007443),
            'wgap': [0.409]},
 'V4046_Sgr': {'PA': 76.02083693,
               'R90': np.float64(0.852),
               'RMS': np.float64(41.753024561330676),
               'ccycleniter': 300,
               'cgain': 0.3,
               ...
               'name': 'V4046_Sgr',
               'rgap': [0.105, 0.285],
               'rout': np.float64(0.982103501446425),
               'wgap': [0.101, 0.141]}}
